...
/** forwardRef + prop-spreading so a wrapping MUI Tooltip can attach its ref and hover/focus handlers —
 * without this, Tooltip's cloneElement never reaches a real DOM node and hover never triggers. */
export const OutOfStockBadge = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ style, ...props }, ref) => (
    <div
      ref={ref}
      {...props}
