...
import { AlertThumbnail, AlertApprovalChips, GenerationFailedChip, QcFindingsChip, FailedThumbnail } from './AlertsKanbanBoard';
...
const ACTIVITY_VERB: Record<AlertActivityAction, string> = {
  ...
  offers_reviewed: 'Offers reviewed by',
  assets_approved: 'Assets approved by',
  assets_rejected: 'Assets changes requested by',
  rebuilt: 'Rebuilt by',
  regenerated: 'Regenerated by',
  sent: 'Sent by',
          ...
          {alerts.map((alert) => {
            ...
            return (
              <TableRow
                ...
                sx={{
                  cursor: 'pointer', background: isSelected ? 'rgba(99,86,225,0.08)' : failed ? '#FDEDED' : 'transparent',
              ...
              >
                ...
                <TableCell sx={BODY_CELL_SX}>
                  {failed ? <FailedThumbnail size={40} /> : <AlertThumbnail assets={assetsByAlertId.get(alert.id) ?? []} size={40} />}
                </TableCell>
                <TableCell sx={{ ...BODY_CELL_SX, maxWidth: 280 }}>
                  {!failed && qcFindingCount > 0 && (
                    <div style={{ marginBottom: 4 }}>
                      <QcFindingsChip count={qcFindingCount} />
                    </div>
                  )}
